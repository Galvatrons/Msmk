      ...
      <div class="scrollBox">
        ...
        <div class="teach_team">
          ...
          <div class="teach_wrapper">
            <div class="teach_left" v-for='(item,index) in CourseInfo.teachers_list' :key="index">
        ...
        <div class="classify_jieshao">
          ...
          <p class="font">自主招生冲刺讲座6-多元方程组与可转化为多元方程组问题</p>
        </div>
